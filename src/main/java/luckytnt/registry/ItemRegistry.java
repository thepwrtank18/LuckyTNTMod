...
public class ItemRegistry {
	...
	public static final RegistryObject<Item> GREEN_CANDY = LuckyTNTMod.itemRegistry.register("green_candy", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEdible().fast().nutrition(1).effect(new MobEffectInstance(MobEffects.JUMP, 200, 2), 1).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 2), 1).build())));
	public static final RegistryObject<Item> BLUE_CANDY = LuckyTNTMod.itemRegistry.register("blue_candy", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEdible().fast().nutrition(1).effect(new MobEffectInstance(MobEffects.WATER_BREATHING, 1200, 0), 1).effect(new MobEffectInstance(MobEffects.ABSORPTION, 500, 2), 1).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 1200, 0), 0).build())));
	public static final RegistryObject<Item> PURPLE_CANDY = LuckyTNTMod.itemRegistry.register("purple_candy", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEdible().fast().nutrition(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 100, 3), 1).effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 2000, 1), 1).build())));
	public static final RegistryObject<Item> YELLOW_CANDY = LuckyTNTMod.itemRegistry.register("yellow_candy", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEdible().fast().nutrition(1).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 2000, 3), 1).build())));;
